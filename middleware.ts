...
const redirects = [
  ...
  { from: '/warp-fa2e-bubble-gun-asana-remix', to: '/music/warp-fa2e-bubble-gun-asana-remix' },
  ...
  { from: '/asana-ft-yehor-ratatata', to: '/music/asana-ft-yehor-ratatata' },
  { from: '/sollist-distractor', to: '/music/sollist-distractor' },
  { from: '/yehor-freaky-ep', to: '/music/yehor-freaky-ep' },
  { from: '/asana-neurofunk-symphony', to: '/music/asana-neurofunk-symphony' },
  { from: '/?p=270', to: '/music' },
  { from: '/asana-i-just-wanna-neurofuck', to: '/music/asana-i-just-wanna-neurofuck' },
  { from: '/asana-neuro-stomper', to: '/music/asana-neuro-stomper' },
  { from: '/saintxavio-zirah', to: '/music/saintxavio-zirah' },
  { from: '/vecster-feat-brain-wave-badman', to: '/music/vecster-feat-brain-wave-badman' },
  ...
  { from: '/ideatorz-stick-to-the-musich', to: '/music/ideatorz-stick-to-the-musich' },
  { from: '/asana-this-land-will-burn', to: '/music/asana-this-land-will-burn' },
  { from: '/led-xerxes', to: '/music/led-xerxes' },
  { from: '/ill-fated-follow-me', to: '/music/ill-fated-follow-me' },
  { from: '/syncord-sins-marvel-laboratory', to: '/music/syncord-sins-marvel-laboratory' },
  { from: '/asana-mosquito', to: '/music/asana-mosquito' },
  { from: '/led-lost-fighters', to: '/music/led-lost-fighters' },
  { from: '/emzee-dirigentes-unknown-remix', to: '/music/emzee-dirigentes-unknown-remix' },
  ...
  { from: '/ill-fated-noble-sacrifice', to: '/music/ill-fated-noble-sacrifice' },
  ...
  { from: '/richart-franshrek-black-cough', to: '/music/richart-franshrek-black-cough' },
  { from: '/max-shade-kick-bass', to: '/music/max-shade-kick-bass' },
  { from: '/xsonsence-connected', to: '/music/xsonsence-connected' },
  { from: '/asana-neurogasm-warp-fa2e-remix', to: '/music/asana-neurogasm-warp-fa2e-remix' },
  ...
  { from: '/chemical-chronicles-2024', to: '/music/chemical-chronicles-2024' },
