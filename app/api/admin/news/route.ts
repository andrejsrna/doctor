...
export async function POST(request: NextRequest) {
  ...
  const created = await prisma.news.create({ data: {
    ...
    mixDownloadUrl: data.mixDownloadUrl || null,
    mixDownloadKey: data.mixDownloadKey || null,
    mixArtistId: data.mixArtistId || null,
...
export async function PATCH(request: NextRequest) {
  ...
  const updated = await prisma.news.update({ where: { id }, data: {
    ...
    mixArtistId: data.mixArtistId === '' ? null : data.mixArtistId ?? undefined,
