    ...
    <>
      ...
      <section className="py-20 px-4 relative" ref={sectionRef}>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          {/* removed header and info cards under hero */}
          ...
          <h3 className="text-2xl font-bold mb-8 text-center text-white">Latest <span className="text-purple-500">DnB Tracks</span></h3>
