...
const articleUrl = 'https://dnbdoctor.com/news/why-nobody-listens-to-your-neurofunk-tracks'
...
export default function WhyNobodyListensToYourNeurofunkTracksPage() {
  const jsonLd = {
    ...
    image: ['https://dnbdoctor.com/articles/why-nobody-listens-neurofunk-tracks.png'],
    author: {
      '@type': 'Organization',
      name: 'DnB Doctor',
    },
